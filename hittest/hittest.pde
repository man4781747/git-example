...
void draw() {
  ...
  /* mouse */
  F_mouse_bk_x = new float[4];
  F_mouse_bk_y = new float[4];
  ...
  /*
  fill(255,I_hit*255,0);
  noStroke();
  quad(F_mouse_bk_x[0], F_mouse_bk_y[0],
       F_mouse_bk_x[1], F_mouse_bk_y[1],
       F_mouse_bk_x[2], F_mouse_bk_y[2],
       F_mouse_bk_x[3], F_mouse_bk_y[3]);
  */
 ...
 // ellipse(F_mouse_bl_x[1],F_mouse_bl_y[1],F_ball_r,F_ball_r);
  ...
  //I_hit = BKandBK_HitOrNotHit(F_base_bk_x,F_base_bk_y,F_mouse_bk_x,F_mouse_bk_y);
  CandBK_HitOrNotHit(F_mouse_bl_x[0],F_mouse_bl_y[0],F_ball_r/2,F_base_bk_x,F_base_bk_y);
